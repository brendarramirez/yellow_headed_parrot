...
## Yellow-headed Parrot (*Amazona oratrix*) SNP filtering and processing - Keeping Honduras
...
#Honduras would get removed if we use this cutoff - removing top 6 samples by name and keeping Honduras
# vcfR.trim<-missing_by_sample(vcfR, cutoff = 0.80)

#removing Tabasco_LSUMZ_23890, Tamaulipas_MLZ_40635, Belize_BC_A112, Tamaulipas_MLZ_39530, Oaxaca_MLZ_45517, Tamaulipas_MLZ_40633
vcfR.trim <- vcfR[, !colnames(vcfR@gt) %in% c("ao_LSUMZ_23890", "ao_MLZ_40635", "ao_BC_A112", "ao_MLZ_39530", "ao_MLZ_45517", "ao_MLZ_40633")]
...
#Honduras sample sticks out because it is missing a lot fo data
...
# vcfR::write.vcf(vcfR.trim.80, "~/Dropbox/08_yhpa_072025/yhpa_final_filtered_honduras.vcf.gz")
```
...
# stamppPhylip(distance.mat=sample.div.80, file="~/Dropbox/08_yhpa_072025/splitstree/oratrix.80.honduras.splitstree.txt")

knitr::include_graphics("~/Dropbox/08_yhpa_072025/splitstree/oratrix.80.splitstree.honduras.png")
```
...
# write.csv(miss.df, "~/Dropbox/08_yhpa_072025/yhpa_final_filtered_stats.honduras.csv")
```
